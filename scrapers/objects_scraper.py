...
url='http://backrooms-wiki.wikidot.com/objects'
...
with open('data/backrooms_objects.csv', 'w', newline='', encoding='utf-8') as file:
...
analyzed_file_path = 'data/backrooms_objects_analyzed.csv'
if os.path.isfile(analyzed_file_path):
    timestamp = datetime.now().strftime('%Y%m%d%H%M%S')
    new_analyzed_file_path = f'data/backrooms_objects_analyzed_{timestamp}.csv'
...
csv_file_path = 'data/backrooms_objects_analyzed.csv'
